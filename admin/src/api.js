...
export const api = {
  ...
  activity: (limit = 15, opts = {}) =>
    request(`/admin/activity?limit=${limit}`, opts),
  ...
  createMember: (body) =>
    request('/admin/members', { method: 'POST', body }),
  updateMember: (id, body) =>
    request(`/admin/members/${id}`, { method: 'PUT', body }),
  deleteMember: (id) =>
    request(`/admin/members/${id}`, { method: 'DELETE' }),

  createTenant: (body) =>
    request('/admin/tenants', { method: 'POST', body }),
  updateTenant: (id, body) =>
    request(`/admin/tenants/${id}`, { method: 'PUT', body }),
  deleteTenant: (id) =>
    request(`/admin/tenants/${id}`, { method: 'DELETE' }),

  createSeminar: (body) =>
    request('/admin/seminars', { method: 'POST', body }),
  updateSeminar: (id, body) =>
    request(`/admin/seminars/${id}`, { method: 'PUT', body }),
  ...
  deleteSeminar: (id) =>
    request(`/admin/seminars/${id}`, { method: 'DELETE' }),
  ...
  tables: (opts) => request('/admin/tables', opts),
  ...
  generateTables: (body) =>
    request('/admin/tables/generate', { method: 'POST', body }),
  updateTable: (id, body) =>
    request(`/admin/tables/${id}`, { method: 'PUT', body }),
  deleteTable: (id) =>
    request(`/admin/tables/${id}`, { method: 'DELETE' }),
  chapters: (opts) => request('/admin/chapters', opts),
  createChapter: (name) =>
    request('/admin/chapters', { method: 'POST', body: { name } }),
