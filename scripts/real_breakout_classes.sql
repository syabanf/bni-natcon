-- Load the four real breakout classes (and their speakers) into a database
...
WHERE seminar_id IN (SELECT id FROM seminars WHERE room LIKE 'Breakout Room %');
...
FROM (VALUES
    ('Breakout Room 1', 'Flavia N. Sungkit, M.Psi., Psikolog', 'speaker',   'HR Consultant · Ikigai',                                  '/speakers/flavia-sungkit.jpg',     0),
    ('Breakout Room 1', 'Roby Oktober',                        'moderator', '',                                                        '/speakers/roby-oktober.jpg',       1),
    ('Breakout Room 2', 'Viktor Iwan',                         'speaker',   '',                                                        '/speakers/viktor-iwan.jpg',        0),
    ('Breakout Room 2', 'Irfan Arsandi',                       'speaker',   'IT & Digital Transformation Consultant · WIT Indonesia',   '/speakers/irfan-arsandi.jpg',      1),
    ('Breakout Room 2', 'Ryan Kristomulyono',                  'moderator', '',                                                        '/speakers/ryan-kristomulyono.jpg', 2),
    ('Breakout Room 3', 'Ben Wirawan',                         'speaker',   'Co-Founder & CEO · Torch',                                '/speakers/ben-wirawan.jpg',        0),
    ('Breakout Room 3', 'Selina Nicole',                       'speaker',   'Founder · LEKA',                                          '/speakers/selina-nicole.jpg',      1),
    ('Breakout Room 3', 'David Gan',                           'moderator', 'CEO & Founder · Arkova Training & Consulting',            '/speakers/david-gan.jpg',          2),
    ('Breakout Room 4', 'Suntoro Suciatmaja',                  'speaker',   '',                                                        '/speakers/suntoro-suciatmaja.jpg', 0)
